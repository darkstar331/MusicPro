      ...
      <MusicPlayerProvider>
        <html lang="en">
          ...
          <body className={`${roboto.className} h-[100vh] overflow-y-hidden relative bg-slate-950`}>
            {/* Responsive circle backgrounds */}
            <div className="absolute bottom-0 left-[-0%] top-[-10%] sm:top-[-5%] md:top-[-3%] lg:top-[-2%] h-[300px] w-[300px] sm:h-[400px] sm:w-[400px] md:h-[500px] md:w-[500px] lg:h-[600px] lg:w-[600px] 2xl:h-[700px] 2xl:w-[700px] rounded-full bg-[radial-gradient(circle_farthest-side,rgba(255,0,182,.15),rgba(255,255,255,0))]"></div>
