            ...
            <div>
                {status === 'authenticated' ? (
                    ...
                    <button
                        ...
                        className="bg-gray-800 hover:bg-gray-700 text-white font-medium border focus-within:border-amber-600 rounded-full px-4 py-2 transition duration-300 flex items-center justify-center"
                    >
