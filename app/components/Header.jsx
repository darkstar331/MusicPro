...
const Header = () => {
    ...
    return (
        <nav className='flex justify-between items-center p-5 bg-[#010101] text-white shadow-md'>
            ...
            <div>
                {status === 'authenticated' ? (
                                ...
                                {dropdownVisible && (
                                    <div className="absolute right-0 mt-2 w-64 bg-slate-700 text-white rounded-lg shadow-lg py-3 z-10 animate-slide-down">
                                        ...
                                        <button
                                            ...
                                            className="block w-full text-left px-4 py-2 text-white hover:bg-gray-800 transition duration-300"
                                        >
                                            Log Out
                                        </button>
                                    </div>
                    ...
                    <button
                        ...
                        className="bg-gray-800 hover:bg-gray-700 text-white font-medium border focus-within:border-amber-600 rounded-full px-4 py-2 transition duration-300"
                    >
                        Sign In with Github
                    </button>
                )}
